...
const PoolPage = () => {
    ...
    return (
        <SmoothScroll>
            <Head>
                <title>БАУНТИ</title>
                <meta name="description" content="БАУНТИ"/>
            </Head>
            <PageLayout>
                <Main
                    ...
                    />
                <Colors list={colors} ex={<p>Бассейны «БАУНТИ»: комфорт превыше всего! Удобный и стильный бассейн, в котором каждый получит истинное наслаждение от принятия солнечных ванн и комфортного отдыха</p>}/>
                <Key>
                    ...
                    <br/>
                    <br/>
                    Заводская теплоизоляция (ППУ 4 см) -  57 600 руб.
                    <br/>
                    <br/>
                    Композитный бордюрный камень (цвета капучино и оникс) - 64 800 руб.
                    <br/>
                    <br/>
