...
const PoolPage = () => {
    ...
    return (
        <SmoothScroll>
            <Head>
                <title>КЛАССИК 852</title>
                <meta name="description" content="КЛАССИК 852"/>
            </Head>
            <PageLayout>
                <Main
                    ...
                    />
                <Colors list={colors} ex={<p>Классический бассейн с римской лестницей и перепадом глубины от 1,5-2 м, широкие скругленные ступени которой станут излюбленным местом детских игр.</p>}/>
                <Key>
                    ...
                    <br/>
                    <br/>
                    Композитный бордюрный камень (цвета капучино и оникс) - 115 200 руб.
                    <br/>
                    <br/>
