...
const PoolPage = () => {
    ...
    return (
        <SmoothScroll>
            <Head>
                <title>БРИЗ</title>
                <meta name="description" content="БРИЗ"/>
            </Head>
            <PageLayout>
                <Main
                ...
                <Colors 
                    ...
                    ex={<p>
                        ...
                        <br/>
                        <br/>
                        Чаша бассейна Бриз обладает удобными ступенями для входа и выхода из бассейна с разных сторон.
                        <br/>
                        <br/>
                        Расположение ступеней вдоль длинного борта освобождает максимальное место для  плавания в центре бассейна. Эта модель оснащена встроенной зоной отдыха и площадкой для размещения противотока.
                    </p>}/>
                    <Key>
                    ...
                    <br/>
                    <br/>
                    Заводская теплоизоляция (ППУ 4 см) -  42 200 руб.
                    <br/>
                    <br/>
                    Композитный бордюрный камень (цвета капучино и оникс) - 55 560 руб.
                    <br/>
                    <br/>
