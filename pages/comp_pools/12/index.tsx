        ...
        <SmoothScroll>
            <PageLayout>
                <Main
                    ...
                    />
                <Colors list={colors} ex={<p>Бассейны «ПАРАДИЗ»: больше воды, больше удовольствия! Стильные вместительные бассейны, которые прекрасно подойдут для любителей спортивного плавания и соревнований на воде..</p>}/>
                <Key>
                    ...
                    <br/>
                    <br/>
                    Заводская теплоизоляция (ППУ 4 см) -  98 000 руб.
                    <br/>
                    <br/>
                    Композитный бордюрный камень (цвета капучино и оникс) - 102 000 руб.
                    <br/>
                    <br/>
