        ...
        <SmoothScroll>
            <PageLayout>
                <Main
                    ...
                    />
                <Colors list={colors} ex={<p>Бассейны «Поло»: лучшее решение для сауны и бани! Мини-бассейн, идеально подходящий для тех, кто любит охладить тело и разум после посещения жаркой парной или расслабиться с бокалом вкуснейшего напитка в руках.</p>}/>
                <Key>
                    ...
                    <br/>
                    <br/>
                    Заводская теплоизоляция (ППУ 4 см) -  31 400 руб.
                    <br/>
                    <br/>
                    Композитный бордюрный камень (цвета капучино и оникс) - 50 400 руб.
                    <br/>
                    <br/>
