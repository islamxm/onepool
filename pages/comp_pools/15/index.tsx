...
const PoolPage = () => {
    ...
    return (
        <SmoothScroll>
              <Head>
                <title>КЛАССИК 85</title>
                <meta name="description" content="КЛАССИК 85"/>
            </Head>
            <PageLayout>
                <Main
                    ...
                    />
                <Colors list={colors} ex={<p>Классический бассейн с римской лестницей, широкие скругленные ступени которой станут излюбленным местом детских игр.</p>}/>
                <Key>
                    ...
                    <br/>
                    <br/>
                    Заводская теплоизоляция (ППУ 4 см) -  122 400 руб.
                    <br/>
                    <br/>
