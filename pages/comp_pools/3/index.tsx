...
const PoolPage = () => {
    ...
    return (
        <SmoothScroll>
            <Head>
                <title>АВРОРА</title>
                <meta name="description" content="АВРОРА"/>
            </Head>
            <PageLayout>
                <Main
                    ...
                    />
                <Colors list={colors} ex={<p>Миниатюрный бассейн для одиночного отдыха и безопасного купания с маленькими детьми.</p>}/>
                <Key>
                    ...
                    <br/>
                    <br/>
                    Заводская теплоизоляция (ППУ 4 см) -  31400 руб.
                    <br/>
                    <br/>
