...
const PoolPage = () => {
    ...
    return (
        <SmoothScroll>
            <Head>
                <title>РИВЬЕРА 65</title>
                <meta name="description" content="РИВЬЕРА 65"/>
            </Head>
            <PageLayout>
                <Main
                    ...
                    />
                <Colors list={colors} ex={<p>Бассейн, адаптированный для водных аттракционов. Устраивайте соревнования, торжества и вечеринки у воды, наслаждаясь весельем, царящим вокруг!</p>}/>
                <Key>
                    ...
                    <br/>
                    <br/>
                    Заводская теплоизоляция (ППУ 4 см) -  74 100 руб.
                    <br/>
                    <br/>
                    Композитный бордюрный камень (цвета капучино и оникс) - 89 000 руб.
                    <br/>
                    <br/>
