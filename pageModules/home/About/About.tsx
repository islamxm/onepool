                ...
                <div className={styles.in}>
                    ...
                    <AnimWrap className={styles.subtitle}>
                        <motion.div
                            ...
                            >
                            <p>
                            <b>“PoolForm”</b> – это новая компания, образованная объединением трех профессиональных компаний - “Первой бассейной компании”, “KeyBuild” и “ManaWell”. Мы совместили наши усилия, чтобы предложить вам высококачественные услуги 
                            по проектированию, строительству и обслуживанию бассейнов и спа-комплексов в Краснодарском крае.
                            </p>
