        ...
        <Modal
            ...
            <div className={styles.in}>
                ...
                <div className={styles.body}>
                    <p>
                    <b>“PoolForm”</b> – это новая компания, образованная объединением трех профессиональных компаний - “Первой бассейной компании”, “KeyBuild” и “ManaWell”. Мы совместили наши усилия, чтобы предложить вам высококачественные услуги по проектированию, строительству и обслуживанию бассейнов и спа-комплексов в Краснодарском крае.
                    <br/>
                    <br/>
                    <b>“PoolForm”</b> – это новая компания, образованная объединением трех профессиональных компаний - “Первой бассейной компании”, “KeyBuild” и “ManaWell”. Мы совместили наши усилия, чтобы предложить вам высококачественные услуги по проектированию, строительству и обслуживанию бассейнов 
и спа-комплексов в Краснодарском крае.
                    ...
                    <br/>
                    <br/>
                    <b>“KeyBuild”</b> - Строительная Компания, которая работает на рынке Краснодарского края уже много лет. Наша экспертиза в строительстве объектов недвижимости любой сложности и обширный портфель реализованных проектов позволяют нам обеспечить высокое качество работ и выполнение заказов 
                    ...
                    и особенности места установки. Работая с KeyBuild, вы можете быть уверены в качестве и надежности наших услуг..
                    <br/>
                    <br/>
